...
@Component({
  selector: 'app-profile-daca',
  templateUrl: './profile-daca.component.html',
  styleUrls: ['./profile-daca.component.css']
})
export class ProfileDacaComponent implements OnInit {
  userInfo: any;
  editionActive = false;
