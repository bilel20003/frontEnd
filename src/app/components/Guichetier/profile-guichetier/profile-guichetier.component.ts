...
@Component({
  selector: 'app-profile-guichetier',
  templateUrl: './profile-guichetier.component.html',
  styleUrls: ['./profile-guichetier.component.css']
})
export class ProfileGuichetierComponent implements OnInit {
  userInfo: any;
  editionActive = false;
